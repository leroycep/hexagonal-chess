...
pub const Context = struct {
    ...
    pub fn set_cursor(self: @This(), style: CursorStyle) void {
        // TODO
    }
...
pub fn init(allocator: *std.mem.Allocator, app_name: [:0]const u8, screenWidth: i32, screenHeight: i32) !platform.Context {
    ...
    const sdl_window = c.SDL_CreateWindow(app_name, c.SDL_WINDOWPOS_UNDEFINED_MASK, c.SDL_WINDOWPOS_UNDEFINED_MASK, screenWidth, screenHeight, c.SDL_WINDOW_SHOWN | c.SDL_WINDOW_OPENGL) orelse {
...
fn MessageCallback(source: c.GLenum, msgtype: c.GLenum, id: c.GLuint, severity: c.GLenum, len: c.GLsizei, msg: [*c]const c.GLchar, userParam: ?*const c_void) callconv(.C) void {
